...
def explore_csv(csv_path: str):
    ...
    try:
        ...
        for col in df_full.columns:
            ...
            print(f"  - {col:30} | Tipo: {dtype:15} | Não-nulos: {non_null:6} ({100-null_pct:.1f}%) | Únicos: {unique}")
        ...
        if lat_col and lon_col:
            ...
            print(f"  - Registros com coordenadas: {df_full[[lat_col, lon_col]].notna().all(axis=1).sum()}")
        else:
