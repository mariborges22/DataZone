...
def create_geometry_from_coords(df: pd.DataFrame, lat_col: str = 'latitude', lon_col: str = 'longitude') -> gpd.GeoDataFrame:
    """
...
def process_fibra_optica(csv_path: str) -> None:
    ...
    try:
        ...
        for encoding in encodings:
            try:
                df = pd.read_csv(csv_path, encoding=encoding, sep=';')  # Ajustar separador se necessário
