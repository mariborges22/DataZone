...
class AnatelBigQueryETL:
    ...
    def _connect_bigquery(self) -> bool:
        ...
        try:
            ...
            logger.success(f"✅ Conectado ao BigQuery | Projeto faturador: causal-tracker-484821-f1")
            return True
    ...
    def _execute_bigquery(self, query: str) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            bytes_processed = query_job.total_bytes_processed if query_job.total_bytes_processed is not None else 0
...
def main():
    ...
    project_id = os.getenv("GOOGLE_CLOUD_PROJECT") or os.getenv("GCP_PROJECT_ID", "causal-tracker-484821-f1")
